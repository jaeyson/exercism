defmodule PigLatinTest do
  ...
  describe "first consonant letters and ay are moved to the end of words that start with consonants" do
    ...
    # @tag :pending
    test "position of y in a word determines if it is a consonant or a vowel y is treated like a vowel at the end of a consonant cluster" do
      assert PigLatin.translate("rhythm") == "ythmrhay"
    end

    # @tag :pending
    test "position of y in a word determines if it is a consonant or a vowel y as second letter in two letter word" do
